...
def run():
    ...
    training_files = "data/" + hps.data.training_files
    train_dataset = TextAudioSpeakerLoader(training_files, hps.data)
    ...
    if rank == 0:
        validation_files = "data/" + hps.data.validation_files
        eval_dataset = TextAudioSpeakerLoader(validation_files, hps.data)
